...
# 5. Calculate RMSE and NRMSE for each model
## 5.1 Define helper functions 
### 5.1.1 RMSE and NRMSE functions
```{r calc_nrmse}
...
### 5.1.2 Decorator for SLOO-CV crossvalidation function for models using `gstat` library
```{r train_gstat_cv}
...
## 5.2 Calculate RMSE and NRMSE for each weighted and non weighted model
### 5.2.1 Trend surface
...
## 5.3 Combine and show RMSE and NRMSE results of models
...
# 6. Compare models
## 6.1 Show difference in RMSE and NRMSE between best case and average case models
...
### 6.3.1 Define function to generate map plot
...
### 6.3.3 Combine map plots into facets.
...
### 6.3.4 Show facets with combined map plots
